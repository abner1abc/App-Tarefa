...
icon_editar = PhotoImage(file="edit.png").subsample(15,15)
icon_deletar = PhotoImage(file="delete.png").subsample(15,15)


fonte_cabecalho = font.Font(family="Garamond", size=24, weight="bold")
rotulo_cabecalho = tk.Label(janela, text="Tarefas", font=fonte_cabecalho, bg="#d3d3d3", fg="#333").pack(pady=20) 


frame = tk.Frame(janela, bg="#d3d3d3")
frame.pack(pady=10)
